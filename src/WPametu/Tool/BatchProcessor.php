...
class BatchProcessor extends Singleton
{
	...
	public function admin_menu(){
		add_submenu_page('tools.php', $this->__('Do Batch Actions'), $this->__('Batch Actions'), 'manage_options', 'wpametu-batch', [$this, 'render_screen']);
	}
	...
	public function admin_init(){
		if( !defined('DOING_AJAX') || !DOING_AJAX ){
			...
			add_action('wp_ajax_wpametu_batch', [$this, 'ajax']);
		}
	}
