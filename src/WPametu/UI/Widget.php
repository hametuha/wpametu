...
abstract class Widget extends \WP_Widget {
	...
	final public function __construct() {
		...
		parent::__construct( $this->id_base, $this->title, $option, $this->width ? array( 'width' => $this->width ) : array() );
	}
	 ...
	 * @return string|false
	 */
	abstract protected function widget_content( array $instance = array() );
